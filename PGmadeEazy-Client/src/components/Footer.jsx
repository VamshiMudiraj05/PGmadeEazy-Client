      ...
      <div className="container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2">
            <li><NavLink to="/" className="hover:text-orange-500 transition">Home</NavLink></li>
            <li><NavLink to="/find-pg" className="hover:text-orange-500 transition">Find PG</NavLink></li>
            <li><NavLink to="/list-property" className="hover:text-orange-500 transition">List Property</NavLink></li>
